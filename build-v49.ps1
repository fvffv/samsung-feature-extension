...
$root = 'W:\MyFilesWebDavPopupLsp'
$out = Join-Path $root 'build\v49-quickshare-coa-diagnostics'
...
$androidJar = 'W:\.tools\android-sdk\platforms\android-35\android.jar'
$bt = 'W:\.tools\android-sdk\build-tools\35.0.0'
...
& "$bt\apksigner.bat" sign `
    ...
    --out "$out\SamsungFeatureExt-v2.4.apk" `
    "$out\aligned.apk"
& "$bt\apksigner.bat" verify --verbose --print-certs "$out\SamsungFeatureExt-v2.4.apk"

Copy-Item -Force "$out\SamsungFeatureExt-v2.4.apk" 'W:\SamsungWebDavRawMergedLsp.apk'
Copy-Item -Force "$out\SamsungFeatureExt-v2.4.apk" 'W:\MyFilesWebDavPopupLsp.apk'

Get-FileHash "$out\SamsungFeatureExt-v2.4.apk" -Algorithm SHA256
Get-Item "$out\SamsungFeatureExt-v2.4.apk", 'W:\SamsungWebDavRawMergedLsp.apk', 'W:\MyFilesWebDavPopupLsp.apk' |
