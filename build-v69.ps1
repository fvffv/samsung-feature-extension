...
& $buildScript `
    -BuildCode 160 `
    -OutputVersion '1.3.24' `
    -OutputTag 'ExpertRAW-SDHMS-WebDAV-AudioEraser-OneUI85-SystemUI-Camera' `
    -BuildFlavor 'expert-raw-sdhms-v36-webdav-web-icon-audio-eraser-oneui85-systemui16-camera16-5-horizontal-lock'

if ($LASTEXITCODE -ne 0) {
    throw "v1.3.24 build failed with exit code $LASTEXITCODE"
}
