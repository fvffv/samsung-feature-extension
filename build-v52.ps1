...
try {
    ...
    $root = "$substDrive\"
    $out = Join-Path $root 'build\v140-expert-raw-sdhms-v36-webdav-audio-eraser-native-7.4.12.3'
    ...
    $unsignedApk = Join-Path $out 'SamsungFeatureExtension-v1.3.4-ExpertRAW-SDHMS-WebDAV-AudioEraser-Native-unsigned.apk'
    ...
    $finalApk = Join-Path $out 'SamsungFeatureExtension-v1.3.4-ExpertRAW-SDHMS-WebDAV-AudioEraser-Native.apk'
    ...
    $rootOutput = Join-Path $root 'SamsungFeatureExtension-v1.3.4-ExpertRAW-SDHMS-WebDAV-AudioEraser-Native.apk'
