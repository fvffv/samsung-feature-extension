...
& $buildScript `
    -BuildCode 155 `
    -OutputVersion '1.3.19' `
    -OutputTag 'ExpertRAW-SDHMS-WebDAV-AudioEraser-OneUI85-SystemUI-Camera' `
    -BuildFlavor 'expert-raw-sdhms-v36-webdav-web-icon-audio-eraser-oneui85-systemui16-camera16-5-fps-fix'

if ($LASTEXITCODE -ne 0) {
    throw "v1.3.19 build failed with exit code $LASTEXITCODE"
}
