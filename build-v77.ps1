...
& $buildScript `
    ...
    -BuildFlavor 'expert-raw-sdhms-v36-webdav-web-icon-audio-eraser-oneui85-systemui16-camera16-5-language-dynamic-fix'

if ($LASTEXITCODE -ne 0) {
    throw "v1.25 build failed with exit code $LASTEXITCODE"
}
