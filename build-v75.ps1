...
& $buildScript `
    -BuildCode 166 `
    -OutputVersion '1.3.30' `
    -OutputTag 'ExpertRAW-SDHMS-WebDAV-AudioEraser-OneUI85-SystemUI-Camera' `
    -BuildFlavor 'expert-raw-sdhms-v36-webdav-web-icon-audio-eraser-oneui85-systemui16-camera16-5-language-switch'

if ($LASTEXITCODE -ne 0) {
    throw "v1.3.30 build failed with exit code $LASTEXITCODE"
}
